...
export class MockWebProvider implements ProviderAdapter {
  readonly id = "mock_web";
  readonly name = "Mock Web Provider";
  ...
  async healthCheck(): Promise<ProviderHealthStatus> {
    return {
      ...
      message: this.scenario === "failure" ? "Mock Web provider is unhealthy" : "Mock Web provider is healthy"
    };
  }
